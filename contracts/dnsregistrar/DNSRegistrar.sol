...
import "../registry/FNSRegistry.sol";
...
contract DNSRegistrar {
    ...
    bytes4 private constant DNSSEC_CLAIM_ID =
        bytes4(
     ...
     *        record for '_fns.' + name, with the value 'a=0x...'. Ownership of
    ...
    {
        return
            interfaceID == INTERFACE_META_ID || interfaceID == DNSSEC_CLAIM_ID;
    }
